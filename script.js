...
window.onload = function() {
    ...
    // 3. Handle App Shortcuts (e.g. Long press icon -> Scientific)
...
// FIX: Prevents multiple operators like "++" or "*/"
...
function appendFunc(func) {
    playSound();
    // Implicit Multiplication: 5sin(x) -> 5*sin(x)
...
// --- KEYBOARD SUPPORT (Added for Desktop/Laptop Users) ---
